...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalSlider_1.setMinimum(-10)
        self.verticalSlider_1.setMaximum(110)
        ...
        self.verticalSlider_2.setMinimum(-10)
        self.verticalSlider_2.setMaximum(110)
        ...
        self.verticalSlider_3.setMinimum(-10)
        self.verticalSlider_3.setMaximum(110)
